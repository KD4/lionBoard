...
public class Tenth2ServiceConfig {
    ...
    public static String getServiceName() { return TENTH2_SERVICE; }
    public static String getUploadHost() { return (isService) ? TENTH2_SERVICE_UPLOAD_HOST : TENTH2_TEST_UPLOAD_HOST;   }
    public static String getServiceHost() { return (isService) ? TENTH2_SERVICE_SERVICE_HOST : TENTH2_TEST_SERVICE_HOST; }
    public static String getReadKey() { return (isService) ? TENTH2_SERVICE_READ_KEY : TENTH2_TEST_READ_KEY; }
    public static String getWriteKey() { return (isService) ? TENTH2_SERVICE_WRITE_KEY : TENTH2_TEST_WRITE_KEY; }
}